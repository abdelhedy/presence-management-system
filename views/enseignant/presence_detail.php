...
<body>
    ...
    <div class="main-content">
        <div style="margin-bottom: 2rem;">
            <a href="<?= isset($_GET['from_cours']) ? 'cours_seances.php?id=' . htmlspecialchars($_GET['from_cours']) : 'presences.php' ?>"
                style="color: var(--primary-color); text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; margin-bottom: 1rem;">
                ← Retour
            </a>
        </div>
